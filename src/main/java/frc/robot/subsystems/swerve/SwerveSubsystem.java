...
<<<<<<< HEAD
  ...
  public Command driveToPose(Pose2d pose) {
    ...
    PathConstraints constraints = new PathConstraints(
        swerveDrive.getMaximumVelocity() * 0.1, 4.0,
        swerveDrive.getMaximumAngularVelocity() * 0.1, Units.degreesToRadians(720));
  ...
  public Command driveCommand(DoubleSupplier translationX, DoubleSupplier translationY, DoubleSupplier headingX,
    ...
    return run(() -> {
      ...
      driveFieldOriented(swerveDrive.swerveController.getTargetSpeeds(xInput, yInput,
          ...
          swerveDrive.getMaximumVelocity() * 0.1));
    });
  }
  ...
  public Command driveCommand(DoubleSupplier translationX, DoubleSupplier translationY,
    ...
    return run(() -> {
      // Make the robot move
      swerveDrive.drive(
          new Translation2d(Math.pow(translationX.getAsDouble(), 3) * swerveDrive.getMaximumVelocity() * 0.1,
              Math.pow(translationY.getAsDouble(), 3) * swerveDrive.getMaximumVelocity() * 0.1),
          Math.pow(angularRotationX.getAsDouble(), 3) * swerveDrive.getMaximumAngularVelocity() * 0.1,
          true,
          false);
    });
  }
